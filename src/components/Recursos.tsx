                ...
                <div className="row">
                  <div className="col-md-6 mb-4">
                    <div className="d-flex">
                      ...
                      <div>
                        ...
                        <a href="#" className="btn btn-sm btn-outline-primary">Ver proyecto</a>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-md-6 mb-4">
                    <div className="d-flex">
                      ...
                      <div>
                        <h5>Modelo de Gobernanza Tecnológica Comunitaria</h5>
                        <p>Desarrollo de un modelo de gestión tecnológica inspirado en las formas organizativas tradicionales del pueblo Rrom.</p>
                        <a href="#" className="btn btn-sm btn-outline-primary">Ver proyecto</a>
                      </div>
                    </div>
                  </div>
