      ...
      <div className="container">
        <div className="row gy-4">
          <div className="col-lg-4">
            ...
            <div className="mt-4">
              <a href="#" className="text-white me-3 fs-5" aria-label="Github">
                <i className="bi bi-github"></i>
              </a>
              <a href="#" className="text-white me-3 fs-5" aria-label="Twitter">
          ...
          <div className="col-md-4 col-lg-3">
            ...
            <div className="mb-2">
              ...
              <a href="mailto:contacto@rromysoftwarelibre.org" className="text-decoration-none text-white-50 hover-white">u20231xxxxxx@usco.edu.co</a>
            </div>
            <div className="mb-2">
              <i className="bi bi-geo-alt-fill me-2"></i>
              <span className="text-white-50">Neiva, Colombia</span>
            </div>
            <div className="mb-4">
              <i className="bi bi-building me-2"></i>
              <span className="text-white-50">Universidad Surcolombiana</span>
            </div>
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-md-6 text-center text-md-start">
            <small>&copy; 2025 - Proyecto académico sobre el Pueblo Rrom y el Software Libre</small>
          </div>
